...
export interface TextInputProps extends Omit<ComponentProps<'input'>, 'ref' | 'color' | 'className' | 'size'> {
  label?: string;
      ...
      <div>
        ...
        <div className='relative'>
          ...
          <input
            ...
            className={classNames(
              theme.base,
              squared === 'left' ? theme.rounded.right : squared === 'right' ? theme.rounded.left : theme.rounded.all,
